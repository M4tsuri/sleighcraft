...
//! This module contains everything about communication with the c++ backend.
//! You should not care what happens here.
//! Do not directly use types defined here unless you know what you are doing
